		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Store",
									"targetURL": "#comibsmaterialcreatestore-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsmaterialcreatestore-display": {
								"semanticObject": "comibsmaterialcreatestore",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.materialcreate.store",
									"url": sap.ui.require.toUrl("com/ibs/materialcreate/store")
								}
							}
						}
					}
