		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Production Plant Data",
									"targetURL": "#comibsmaterialcreateproductionplantdata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsmaterialcreateproductionplantdata-display": {
								"semanticObject": "comibsmaterialcreateproductionplantdata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.materialcreate.productionplantdata",
									"url": sap.ui.require.toUrl("com/ibs/materialcreate/productionplantdata")
								}
							}
						}
					}
