		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Initiator",
									"targetURL": "#comibsmaterialcreateinitiator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsmaterialcreateinitiator-display": {
								"semanticObject": "comibsmaterialcreateinitiator",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.materialcreate.initiator",
									"url": sap.ui.require.toUrl("com/ibs/materialcreate/initiator")
								}
							}
						}
					}
