		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Procurment Data",
									"targetURL": "#comibsmaterialcreateprocurmentdata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsmaterialcreateprocurmentdata-display": {
								"semanticObject": "comibsmaterialcreateprocurmentdata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.materialcreate.procurmentdata",
									"url": sap.ui.require.toUrl("com/ibs/materialcreate/procurmentdata")
								}
							}
						}
					}
